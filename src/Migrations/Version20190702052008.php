 ...
 */
final class Version20190702052008 extends AbstractMigration
{
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE user DROP password, CHANGE roles roles LONGTEXT NOT NULL COLLATE utf8mb4_bin');
    }
}
